...
import { TContainerSchema } from '../../shared/hooks/nbn-atlas-api/useChartData';
...
export function SpeciesChart({ colour, data, horizontal, title }: IChart): React.JSX.Element {
