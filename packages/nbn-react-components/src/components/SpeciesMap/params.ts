...
export interface ISpeciesMap {
     ...
     * Default is 0. */
    interactive?: string;
    /** Enables map print control if set to 1. Default is 0. */
    print? : string;
...
export class Params {
    ...
    constructor(props: ISpeciesMap) {
        ...
        this.logo = sanitiseParamList('logo', this.props.logo, ['0', '1', '2'],
                                        '1'); 
        // print
        this.print = sanitiseParamList('print', this.props.print, ['0', '1'],
                                        '0'); 
        // res
    ...
    // -------------------------------------------------------------------------
    /** Determine whether the print control should be visible.
     * 
     * @returns {boolean} - True if print control visible, else False.
     */
    showPrint(): boolean {
        return this.print == '1';
    }
